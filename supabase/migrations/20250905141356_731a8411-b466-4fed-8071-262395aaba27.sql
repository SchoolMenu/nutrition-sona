-- Add school_code to existing tables for multi-tenancy
ALTER TABLE public.children ADD COLUMN school_code text NOT NULL DEFAULT '';
ALTER TABLE public.menu_items ADD COLUMN school_code text NOT NULL DEFAULT '';
ALTER TABLE public.meal_orders ADD COLUMN school_code text NOT NULL DEFAULT '';

-- Update existing records to use the parent's school code
