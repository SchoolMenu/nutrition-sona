...
export const MenuManager = ({ weekMenu, onUpdateMenu }: MenuManagerProps) => {
  ...
  const renderMenuItems = (items: MenuItem[], category: 'meal1' | 'meal2' | 'side') => (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value: 'meal1' | 'meal2' | 'side') => 
